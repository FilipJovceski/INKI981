...
//Go dava brojot na pobedeni rundi na korisnikot i kompjuterot, potoa korisnkot izbira dali kje prodolzi so igra ili nema da prodolzi.
//36ta linija prvo dava broevi od 0 do 5, potoa so dodavanje na 1 taa granica se premestuva na broevi od 1-6.
sum = num + num2;
...
//Ne e neophodno, sprecuva preska vo kodot.
cout << "Error...";
break;
} //end switch
...
system("pause"); // Ja pauzira programata i ceka od korisnikot da pritisne kopce za da prodolzi so rabota.
system("cls"); // Ja brisi konzolata od programta.
